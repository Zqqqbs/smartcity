...
class easy_install(Command):
    ...
    __cant_write_msg = textwrap.dedent().lstrip()

    __not_exists_id = textwrap.dedent().lstrip()

    __access_msg = textwrap.dedent().lstrip()
    ...
    __mv_warning = textwrap.dedent().lstrip()
    ...
    __editable_msg = textwrap.dedent().lstrip()
    ...
    __no_default_msg = textwrap.dedent().strip()
...
class ScriptWriter:
    ...
    template = textwrap.dedent(r).lstrip()
